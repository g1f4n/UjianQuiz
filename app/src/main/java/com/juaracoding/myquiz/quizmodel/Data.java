...
public class Data implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -8179527011235662578L;

    protected Data(Parcel in) {
        in.readList(this.soalQuizAndroid, (com.juaracoding.myquiz.quizmodel.SoalQuizAndroid.class.getClassLoader()));
    }
